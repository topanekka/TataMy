...
<div class="card mt-4 ms-3 me-3">
  <div class="card-body">
      ...
      <div class="mt-3" id="tsk_password">
          <label id="tplabel" id="tsk_pass_label"> OTP</label>
          <input type="text" class="form-control" placeholder="OTP" id="tpy_pass" autocomplete="off"/>
      </div>
      <div class="mt-3">
          <button class="btn btn-warning" id="tpy_process">Process</button>
          <br>
          <br>
          <a href="../tools/tools.html" class="btn btn-success" >Back To Tools Page</a>
      </div>
    
  </div>

  <h6 class="text-light" style="text-align:center;">TataPlay PlayList Genrator [@Spidyworld] [@MaxMentor]</h6><br>
</div>
